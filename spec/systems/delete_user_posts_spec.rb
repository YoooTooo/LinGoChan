...
RSpec.describe "administrator's move", type: :system do
  ...
  subject_post1 = SubjectPost.create(id:1, img: "xxxxxxxxxxxxx.png")
  reply_post1 = ReplyPost.create(id:1, user_id:1, subject_post_id:1, content: "りんごちゃん")
  feedback_post1 = FeedbackPost.create(id:1, content: "みかんちゃんですね")
  ...
  context "delete user successfully" do
    ...
    context "delete subject_post" do
      before "visit subject_post show" do
        visit subject_post_path(subject_post)
        expect(current_path).to eq subject_post_path(subject_post)
      end
    end
